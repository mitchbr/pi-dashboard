    ...
    return (
        <>
            <div className='portfolio-body'>
                ...
                <p>Let's connect on <a href="https://www.linkedin.com/in/mitchbr/">LinkedIn</a>!</p>

                <h1>Current Projects</h1>
                <h2>Grocery List App</h2>
                <a>https://github.com/mitchbr/grocery_list_app</a>
                ...
                <h2>StickieDB</h2>
                <p>Frontend: <a>https://github.com/mitchbr/sticker_app</a></p>

                <p>Backend: <a>https://github.com/mitchbr/sticker_api</a></p>
