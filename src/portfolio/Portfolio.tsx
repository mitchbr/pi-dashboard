      ...
      <div className='page-body'>
        ...
        <div className='page-grid workouts-grid'>
          <div className='grid-item grid-text workouts-top-left'>
            <p>My first time exploring HTMX, this is a monolith using the Django web framework with a PostgreSQL database. One of the main drivers behind this project was exploring technologies I could use to more quickly stand up projects. Technologies like React are great, but building a monolith using Django and HTMX speeds things up without the need to maintain and deploy both a UI and an API. I’d heard this stack was great for writing minimal code, and I’ve found that to be the case. Adding in Tailwind CSS (In addidion to a very fun <a href="https://jdan.github.io/98.css/#intro">Windows 98 style library</a>), the structure of the code is extremely simple. For more “Backend” things, I am very comfortable with the Django framework, and the frontend is as simple as writing HTML with some “extended” capabilities.</p>
          </div>
